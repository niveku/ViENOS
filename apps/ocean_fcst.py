...
@app.callback(
    Output("Main_ocean_fcst", "children"),  # Actualiza este componente HTML
...
def update_graph(tipo, start_date, end_date, pathname):
    """
    Se encarga de la actulización de los contenidos de la sección de predicción de oceanografía.
